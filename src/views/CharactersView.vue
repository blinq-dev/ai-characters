...
<template>
    <div class="fixed z-20 top-0 left-0 right-0 flex gap-2  text-white p-5">
      <button @click="exportAllToClipboardJson" class="backdrop-brightness-50 backdrop-blur-xl text-white rounded-lg p-2">Export</button>
      <button @click="importAllFromClipboardJson" class="backdrop-brightness-50 backdrop-blur-xl text-white rounded-lg p-2">Import</button>
  </div>
